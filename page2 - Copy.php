...
<title>জালশুকা সরকারি প্রাথমিক বিদ্যালয়</title>
<style id="applicationStylesheet" type="text/css">
	...
	* {
	...
	#page2 {
		...
		width: 360px;
		height: 640px;
		background-color: rgba(211,183,239,1);
		overflow: hidden;
		--web-view-name: page2;
		--web-view-id: page2;
		--web-scale-on-resize: true;
	...
	#Copyright__2020_Jalshuka_Gover {
		left: 8px;
		top: 623px;
		position: absolute;
		overflow: visible;
	...
	.Rectangle_10 {
		...
		left: 0px;
		top: 0px;
		background-color: rgba(134,132,201,1);
	}
	#LOGIN {
		left: 12px;
		top: 0px;
...
<div id="page2">
	<svg class="Rectangle_3">
		<rect id="Rectangle_3" rx="0" ry="0" x="0" y="0" width="360" height="21">
		</rect>
	</svg>
	<div id="Copyright__2020_Jalshuka_Gover">
		<span>Copyright © 2020 Jalshuka Government Primary School, All rights reserved.</span>
	</div>
	<div id="INFORMATION">
	...
	<div id="Group_100">
		<svg class="Rectangle_27">
			<rect id="Rectangle_27" rx="20" ry="20" x="0" y="0" width="271" height="44">
			</rect>
		</svg>

		<div id="Username">
			<span><input type="text" name="username" class="Rectangle_27" placeholder="Username" required=""></span>
		</div>
	...
	<div id="Group_101">
		<div id="Group_99">
			<svg class="Rectangle_28">
				<rect id="Rectangle_28" rx="20" ry="20" x="0" y="0" width="271" height="44">
				</rect>
			</svg>
			<div id="Password">
				<span><input type="password" name="password" class="Rectangle_28" placeholder="Password" required=""></span>
			</div>
		</div>
	</div>
	<div onclick="application.goToTargetView(event)" id="Group_10">
		<div id="Group_9">
			<svg class="Rectangle_10">
				<rect id="Rectangle_10" rx="10" ry="10" x="0" y="0" width="79" height="20">
				</rect>
			</svg>
			<div id="LOGIN">
				<span>
		<input type="Submit" name="submit" class="Rectangle_10" placeholder="LOGIN"></span>
			</div>
		</div>
	</div>
	<div onclick="application.goToTargetView(event)" id="Group_42">
		<svg class="Rectangle_15">
			<rect id="Rectangle_15" rx="8.5" ry="8.5" x="0" y="0" width="73" height="17">
			</rect>
		</svg>
		<div id="BACK">
	...
	<svg class="Line_1" viewBox="0 0 170 1">
		<path id="Line_1" d="M 0 0 L 170 0">
		</path>
	</svg>
	<div id="Group_41">
		<img id="DPE_Logo" src="‪DPE_Logo.png"  srcset="DPE_Logo.jpg 1x, DPE_Logo@2x.jpg 2x">
		<div id="___">
			<span>জালশুকা সরকারি প্রাথমিক বিদ্যালয়</span>
		</div>
	</div>
</div>
</body>
